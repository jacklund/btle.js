...
function encodeAdvData(values, isScanResponse) {
  ...
  if (values.hasOwnProperty('mfgSpecific')) {
    ...
    if (typeof values.mfgSpecific == 'string') {
      ...
      buffer = Buffer.concat([new Buffer(values.mfgSpecific.companyID, 'hex'),
...
module.exports.advertise = function(options, values, scanValues) {
  ...
  if (!options.hasOwnProperty('advType') && !options.hasOwnProperty('minInterval') &&
...
module.exports.iBeacon = function() {
  /*
  ...
  */
  var values = {
    flags: 0x1a,
    mfgSpecific: {
      companyID: COMPANY_IDS.APPLE,
      data: '0215e2c56db5dffb48d2b060d0f5a71096e000000000c5'
    }
  };
