...
function Service(handle, serviceUUID, includes, characteristics, peripheral) {
  this.declaration = attribute.create(handle, gatt.AttributeTypes.PRIMARY_SERVICE, UUID.getUUID(serviceUUID));
...
module.exports.create = function(handle, serviceUUID, includes, characteristics, endHandle, peripheral) {
  return new Service(handle, serviceUUID, includes, characteristics, endHandle, peripheral);
}
