...
UUID.prototype.toString = function() {
  return this.isLongUUID() ? this.longString : this.shortString;
}

UUID.prototype.size = function() {
  return this.isLongUUID() ? 128 : 16;
}

UUID.prototype.isLongUUID = function() {
  return this.shortString == null;
}

UUID.prototype.isShortUUID = function() {
  return this.shortString != null;
}
