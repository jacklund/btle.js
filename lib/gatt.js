...
module.exports.createGATTService = function(start, end) {
  ...
  characteristics.push(characteristic.create(0x02, characteristic.Properties.INDICATE, gatt.CharTypes.SERVICE_CHANGED, data));
  var service = service.create(0x01, gatt.Services.GATT, null, characteristics);
