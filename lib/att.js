...
Attribute.prototype.enableNotifications(central) {
...
Attribute.prototype.disableNotifications() {
...
Attribute.prototype.enableIndications(central) {
  if (this.notificationListener) {
    throw new Error('Cannot enable notifications and indications on the same attribute');
  }
...
Attribute.prototype.disableIndications() {
  if (this.indicationListener) {
